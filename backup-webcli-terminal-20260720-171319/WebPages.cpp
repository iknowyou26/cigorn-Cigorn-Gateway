...
std::string WebPages::TerminalPage()
{
    ...
    ss << "<input id=\"command\" type=\"text\" "
          "placeholder=\"Enter Cigorn command\">\r\n";

    ss << "<button type=\"button\" onclick=\"sendCommand()\">";
    ss << "Send";
    ss << "</button>\r\n";
    ...
    ss << "document.getElementById('command')";
    ss << ".addEventListener('keydown', function(event) {\r\n";
