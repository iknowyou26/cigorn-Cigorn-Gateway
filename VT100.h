 ...
 * Author: john
 *
 * Created on October 18, 2010, 12:42 AM
...
#define cRED        "\033[0;31m"        /* 0 -> normal ;  31 -> red */
#define cCYAN       "\033[1;36m"        /* 1 -> light ;  36 -> cyan */
#define cGREEN_ul   "\033[4;32m"        /* 4 -> underline ;  32 -> green */
#define cBLUE_st    "\033[9;34m"        /* 9 -> strike ;  34 -> blue */
#define cPURPLE     "\033[0;35m"        /* 0 -> normal ;  35 -> red */
#define cNONE       "\033[0m"           // Back to default colors
#define cNORMAL     "\033[0m"           // Back to default colors
#define cBLACK      "\033[22;30m"
#define cGREEN      "\033[22;31m"
#define cRESET      "\e[m"

#define cHEADING   "\033[4;35m"    /* 4 -> underline ;  35 -> magenta */
#define cITEM      "\033[0;34m"    /* 0 -> normal ;  34 -> blue */
#define cHEADLINE  "\033[0;36m"    /* 0 -> normal ;  36 -> cyan */
#define cUNIT      "\033[0;36m"    /* 0 -> normal ;  36 -> cyan */
#define cBOLDITEM  "\033[1;35m"    /* 1 -> bold   ;  34 -> purple */
